...
includes(dashboardSource, 'selectedAgent.agentId === "status-only" ? "LoopX 状态投影 · 仅查状态"', "status-only answer attribution");
includes(dashboardSource, 'selectedAgent.agentId === "status-only" ? "仅查状态" : "LoopX 管家"', "deterministic answer author attribution");
