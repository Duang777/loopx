...
| Product-code net change | Final merge-base classification is +4,053/−369 product LOC, net +3,684; tests/fixtures/examples are +3,592/−154, net +3,438; generated contracts are +3/−0 and docs are excluded. The increase delivers a complete provider-neutral transaction, one successor semantic owner, real File/PostgreSQL conformance, public facade parity, and durable mutation gates; it is not counted as deletion payoff. |
