...
| 产品代码净增减 | 最终 merge-base 分类为产品代码 +4,053/−369，净增 3,684；test/fixture/example 为 +3,592/−154，净增 3,438；generated contract 为 +3/−0，docs 不计入。该增长交付完整 provider-neutral transaction、单一 successor semantic owner、真实 File/PostgreSQL conformance、public facade parity 与持久 mutation gate，不记作 deletion payoff。 |
